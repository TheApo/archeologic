...
public class OneTileCornerCheck extends Question {
    ...
    public OneTileCornerCheck(byte[][] solution, int tile, byte[][] currentTile) {
        ...
        for (int y = 0; y < this.solution.length; y++) {
            for (int x = 0; x < this.solution[0].length; x++) {
                if ((y == 0 || y == this.solution.length - 1) &&
                    (x == 0 || x == this.solution[0].length - 1)) {
        ...
        this.setQuestionEnum(QuestionEnum.CORNER_BORDER_CHECK);
    }
    ...
    public void draw(GameScreen screen, int addX, int addY, int size) {
        ...
        for (int y = 0; y < this.solution.length; y++) {
            for (int x = 0; x < this.solution[0].length; x++) {
                screen.getRenderer().setColor(Constants.COLOR_BLACK[0], Constants.COLOR_BLACK[1], Constants.COLOR_BLACK[2], 1f);
                if ((y == 0 || y == this.solution.length - 1) && (x == 0 || x == this.solution[0].length - 1)) {
    ...
    public String getText() {
        String answer = "";
        answer = Localization.getInstance().getCommon().get("question_corner_border");
        ...
        for (int i = 0; i < solutionsReal.size(); i++) {
            ...
            for (int y = 0; y < solution.length; y++) {
                for (int x = 0; x < solution[0].length; x++) {
                    if (notOnBorder) {
                        if ((y == 0 || y == solution.length - 1) && (x == 0 || x == solution[0].length - 1)) {
    ...
    public void renderFilled(GameScreen screen, int changeX, int changeY) {
        ...
        screen.getRenderer().rect(startX + 18 * calc, startY + 18 * calc, 17 * calc, 17 * calc);
        screen.getRenderer().rect(startX + 18 * calc + 4 * 17 * calc, startY + 18 * calc, 17 * calc, 17 * calc);

        screen.getRenderer().rect(startX + 18 * calc, startY + 18 * calc + 4 * 17 * calc, 17 * calc, 17 * calc);
        screen.getRenderer().rect(startX + 18 * calc + 4 * 17 * calc, startY + 18 * calc + 4 * 17 * calc, 17 * calc, 17 * calc);
    }
